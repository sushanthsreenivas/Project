	...
	<div id="content">
		<div class="container">
			<div class="col-md-12">
				<div id="main-slider">
					<div class="item">
						<img src="img/main-slider1.png" alt="" class="img-responsive">
					</div>
					<div class="item">
				...
				<div class="same-height-row">
					...
					<div class="col-sm-4">
						<div class="box same-height clickable">
							...
							<p>You can check the Auction prices and bid according to your
								range.</p>
						</div>
					</div>
					...
					<div class="item">
						<div class="product">
							<div class="flip-container">
								<div class="flipper">
									<div class="front">
										<a href="detail.html"> <img src="img/product3.jpeg" alt=""
											class="img-responsive">
										</a>
									</div>
									<div class="back">
					...
					<div class="item">
						<div class="product">
							<div class="flip-container">
								<div class="flipper">
									<div class="front">
										<a href="detail.html"> <img src="img/product4.jpg" alt=""
											class="img-responsive">
										</a>
									</div>
									<div class="back">
					...
					<div class="item">
						<div class="product">
							<div class="flip-container">
								<div class="flipper">
									<div class="front">
										<a href="detail.html"> <img src="img/product5.jpg" alt=""
											class="img-responsive">
										</a>
									</div>
									<div class="back">
					...
					<div class="item">
						<div class="product">
							<div class="flip-container">
								<div class="flipper">
									<div class="front">
										<a href="detail.html"> <img src="img/product6.jpg" alt=""
											class="img-responsive">
										</a>
									</div>
									<div class="back">
					...
					<div class="item">
						<div class="product">
							<div class="flip-container">
								<div class="flipper">
									<div class="front">
										<a href="detail.html"> <img src="img/product7.jpg" alt=""
											class="img-responsive">
										</a>
									</div>
									<div class="back">
					...
					<div class="item">
						<div class="product">
							<div class="flip-container">
								<div class="flipper">
									<div class="front">
										<a href="detail.html"> <img src="img/product8.jpg" alt=""
											class="img-responsive">
										</a>
									</div>
									<div class="back">
...
<!--  <c:if test="${param.flag }"><script src="js/loginmodal.js"></script></c:if>  -->
